...
public class FenTableFacture extends javax.swing.JFrame {
    ...
    //    getContentPane().setLayout((LayoutManager) new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.GridBagConstraints(250, 85, 742, 400));
        ...
        getContentPane().add(jLab_Imprimer, new org.netbeans.lib.awtextra.GridBagConstraints(20, 10, -1, -1));
        ...
        getContentPane().add(jLab_Aperçu, new org.netbeans.lib.awtextra.GridBagConstraints(20, 80, -1, -1));
        ...
        getContentPane().add(jLab_Exporter, new org.netbeans.lib.awtextra.GridBagConstraints(20, 160, -1, -1));
        ...
        getContentPane().add(jLab_Supprimer, new org.netbeans.lib.awtextra.GridBagConstraints(20, 230, -1, -1));
        ...
        getContentPane().add(jLab_TitreFacture, new org.netbeans.lib.awtextra.GridBagConstraints(260, 10, -1, -1));
        ...
        getContentPane().add(jLab_Recherche, new org.netbeans.lib.awtextra.GridBagConstraints(630, 500, 180, -1));
        getContentPane().add(jTxT_Recherche, new org.netbeans.lib.awtextra.GridBagConstraints(820, 500, 140, 30));

        jBTN_CalculeTotal.setText("Total");
        jBTN_CalculeTotal.setToolTipText("");
        getContentPane().add(jBTN_CalculeTotal, new org.netbeans.lib.awtextra.GridBagConstraints(270, 500, -1, -1));
        ...
        getContentPane().add(jTxT_Total, new org.netbeans.lib.awtextra.GridBagConstraints(340, 500, 120, 30));
